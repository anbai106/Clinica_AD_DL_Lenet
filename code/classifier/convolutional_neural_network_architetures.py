...
###############NOTE: as the DNN architecture was implemented with code virtualenv, try source this virtualenv

from tensorflow.contrib.learn import DNNClassifier
import tensorflow as tf
import numpy as np
import tempfile
from classification_utils import _variable_with_weight_decay, _variable_on_cpu, _activation_summary
