...
tf.app.flags.DEFINE_string('data_dir', '/teams/ARAMIS/PROJECTS/junhao.wen/PhD/ADNI_classification/gitlabs/AD-DL/Data/code/subject_level',
                           """Path to the ADNI T1 2D png data directory.""")
tf.app.flags.DEFINE_string('log_dir', '/teams/ARAMIS/PROJECTS/junhao.wen/PhD/ADNI_classification/gitlabs/AD-DL//Results/code',
